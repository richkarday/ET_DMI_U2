          ...
          return(
            <View style={{width:150, height:150}}>
              <Image
                ...
                source={{uri:`https://firebasestorage.googleapis.com/v0/b/etdmiu2.appspot.com/o/images%2Fprofile_pick_${localStorage.getItem('user')}?alt=media&`}}
               />
      ...
      </Modal>
 {
  //  modal de imagen
    ...
    <View style={{ flex: 1 }}>
      ...
      >
        <View style={{ flex: 1,alignItems:'center',justifyContent:'center' }}>
          <Image source={{ uri: `https://firebasestorage.googleapis.com/v0/b/etdmiu2.appspot.com/o/images%2Fprofile_pick_${localStorage.getItem('user')}?alt=media&` }} style={{ width: 200, height: 200 }} />
          <TouchableOpacity onPress={()=>{}} style={styles.button}>
